...
fire_sound = pygame.mixer.Sound("tanksboom.wav")
explosion_sound = pygame.mixer.Sound("tanksexplosion.wav")
...
largefont = pygame.font.SysFont("timesnewroman", 85)
...
def fireShell(xy, tankx, tanky, turPos, gun_power, xlocation, barrier_width, randomHeight, enemyTankX, enemyTankY):
    ...
    while fire:
        ...
        # y = x**2
        startingShell[1] += int(
            (((startingShell[0] - xy[0]) * 0.015 / (gun_power / 50.0)) ** 2) - (turPos + turPos / (12 - turPos)))
...
def e_fireShell(xy, tankx, tanky, turPos, gun_power, xlocation, barrier_width, randomHeight, ptankx, ptanky):
    ...
    while not power_found:
        ...
        while fire:
            ...
            startingShell[0] += (12 - turPos) * 2
            startingShell[1] += int(
                (((startingShell[0] - xy[0]) * 0.015 / (currentPower / 50.0)) ** 2) - (turPos + turPos / (12 - turPos)))
